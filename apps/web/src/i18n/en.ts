export const en = {
  ...
  'rules.close': 'Got it!',
  'rules.overview': 'One player draws a word while others try to guess it. The faster you guess, the more points you earn!',
  'rules.classic.title': 'Classic Mode',
  'rules.classic.desc': 'Players take turns drawing. Everyone else guesses. Points are awarded for speed — guess fast to score big!',
  'rules.team.title': 'Team Battle',
  'rules.team.desc': 'Two teams compete! Both teams draw the same word simultaneously, but you can only see your own team\'s canvas clearly. The opposing team\'s canvas is blurred.',
  'rules.drawing.title': 'Drawing Tips',
  'rules.drawing.desc': 'Use the pen, eraser, and fill tools. Change brush size and colors. You can undo strokes and clear the canvas. No letters or numbers allowed!',
  'rules.scoring.title': 'Scoring',
  'rules.scoring.desc': 'Guessers earn more points for faster guesses. The drawer also earns points when others guess correctly. In team mode, team scores are combined.',
  'rules.difficulty.title': 'Difficulty Levels',
  'rules.difficulty.desc': 'Easy — common, simple words. Medium — less obvious words that require more thought. Hard — rare or complex words for experienced players.',
  'rules.languages.title': 'Languages',
  'rules.languages.desc': 'Words are available in English, Georgian, Turkish, and Russian. The host selects the word language in the lobby settings.',
