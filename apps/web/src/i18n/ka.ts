...
export const ka: Translations = {
	...
	'home.publicLobbies': 'ბოტთან თამაში',
	'home.lobbiesShort': 'ბოტი',
	'home.layoutTabs': 'ჩანართების განლაგება',
	'home.activeGame': 'თქვენ გაქვთ აქტიური თამაში!',
	'home.rejoinGame': 'შესვლა',
	...
	// Profile
	'profile.noData': 'პროფილის მონაცემები ჯერ არ არის',
	'profile.gamesPlayed': 'თამაშები',
	'profile.wins': 'მოგებები',
	'profile.winRate': 'მოგების %',
	'profile.totalScore': 'ჯამური ქულა',
	'profile.correctGuesses': 'გამოცნობილი',
	'profile.drawings': 'ნახატები',
	'profile.favoriteWord': 'საყვარელი სიტყვა',

	// Leaderboard
	'leaderboard.title': 'რეიტინგი',
	'leaderboard.allTime': 'ყველა დროის',
	'leaderboard.thisWeek': 'ამ კვირის',
	'leaderboard.noPlayers': 'მოთამაშეები ჯერ არ არიან',
	'leaderboard.games': 'თამაში',
	'leaderboard.wins': 'მოგება',
	'leaderboard.score': 'ქულა',

	'leaderboard.byCountry': 'ქვეყანა',
	'leaderboard.byAge': 'ასაკი',
	'leaderboard.selectCountry': 'აირჩიეთ ქვეყანა...',
	'leaderboard.under18': '18-ს ქვემოთ',
	'leaderboard.age1825': '18-25',
	'leaderboard.age2635': '26-35',
	'leaderboard.age36plus': '36+',
	'leaderboard.sameAge': 'მოთამაშეები ასაკით {{age}}',

	// Public Lobbies / Play with Bot
	'lobbies.description': 'შეუერთდი ბოტებთან თამაშს. ნამდვილი მოთამაშეები ნებისმიერ დროს შეუერთდებიან!',
	'lobbies.inProgress': 'მიმდინარეობს',
	'lobbies.waiting': 'ელოდება',
	'lobbies.players': 'მოთამაშე',
	'lobbies.bots': 'ბოტი',
	'lobbies.join': 'შესვლა',
	'lobbies.loading': 'ლობიების ჩატვირთვა...',
	...
	'auth.birthYear': 'დაბადების წელი',
	'auth.logout': 'გასვლა',
	'auth.editProfile': 'პროფილის რედაქტირება',
	'auth.saveProfile': 'შენახვა',
	'auth.invalidCredentials': 'არასწორი მომხმარებლის სახელი ან პაროლი',
	'auth.usernameTaken': 'მომხმარებლის სახელი უკვე დაკავებულია',

	// Profile (extended)
	'profile.country': 'ქვეყანა',
	'profile.birthYear': 'დაბადების წელი',
	...
	'friends.search': 'მომხმარებლის ძებნა...',
	'friends.addFriend': 'დამატება',
	'friends.removeFriend': 'მეგობრის წაშლა',
	'friends.removeConfirm': 'წავშალოთ {name} მეგობრებიდან?',
	'friends.online': 'ონლაინ',
	'friends.offline': 'ოფლაინ',
	'friends.pending': 'მოლოდინში',
	'friends.inGame': 'თამაშში',
	'friends.invite': 'მოწვევა',
	'friends.invited': 'მოწვეულია',
	'friends.requests': 'მოთხოვნები',
	'friends.incoming': 'შემოსული',
	'friends.outgoing': 'გასული',
	'friends.accept': 'მიღება',
	'friends.reject': 'უარყოფა',
	'friends.decline': 'უარყოფა',
	'friends.cancel': 'გაუქმება',
	'friends.noFriends': 'ჯერ არ გყავთ მეგობრები. მოძებნეთ მომხმარებლები!',
	'friends.noRequests': 'მოლოდინში მოთხოვნები არ არის',
	'friends.loginRequired': 'შედით ანგარიშზე მეგობრების სისტემის გამოსაყენებლად',
	'friends.requestSent': 'მეგობრობის მოთხოვნა გაიგზავნა!',
	'friends.alreadyFriends': 'უკვე მეგობრები ხართ',
	'friends.noResults': 'მომხმარებლები ვერ მოიძებნა',
	'friends.gameInviteFrom': '{name} გიწვევთ თამაშში!',
	'friends.inviteFriends': 'მეგობრების მოწვევა',
