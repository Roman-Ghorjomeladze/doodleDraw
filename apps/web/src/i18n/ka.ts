...
export const ka: Translations = {
	...
	'rules.overview': 'ერთი მოთამაშე ხატავს სიტყვას, დანარჩენები ცდილობენ გამოიცნონ. რაც უფრო სწრაფად გამოიცნობთ, მით მეტ ქულას მიიღებთ!',
	'rules.classic.title': 'კლასიკური რეჟიმი',
	'rules.classic.desc': 'მოთამაშეები რიგრიგობით ხატავენ. დანარჩენები გამოიცნობენ. ქულები სისწრაფეზეა დამოკიდებული — გამოიცანით სწრაფად!',
	'rules.team.title': 'გუნდური ბრძოლა',
	'rules.team.desc': 'ორი გუნდი ეჯიბრება! ორივე გუნდი ერთდროულად ხატავს ერთსა და იმავე სიტყვას, მაგრამ მხოლოდ თქვენი გუნდის ტილოს ხედავთ. მოწინააღმდეგის ტილო ბუნდოვანია.',
	'rules.drawing.title': 'ხატვის რჩევები',
	'rules.drawing.desc': 'გამოიყენეთ კალამი, საშლელი და შევსების ხელსაწყოები. შეცვალეთ ფუნჯის ზომა და ფერები. შეგიძლიათ გააუქმოთ მოქმედება და გაასუფთავოთ ტილო. ასოები და ციფრები აკრძალულია!',
	'rules.scoring.title': 'ქულები',
	'rules.scoring.desc': 'გამომცნობები მეტ ქულას იღებენ სწრაფი პასუხისთვის. მხატვარიც იღებს ქულებს, როცა სხვები გამოიცნობენ. გუნდურ რეჟიმში გუნდის ქულები ჯამდება.',
	'rules.difficulty.title': 'სირთულის დონეები',
	'rules.difficulty.desc': 'მარტივი — გავრცელებული, მარტივი სიტყვები. საშუალო — ნაკლებად აშკარა სიტყვები. რთული — იშვიათი ან რთული სიტყვები გამოცდილი მოთამაშეებისთვის.',
	'rules.languages.title': 'ენები',
	'rules.languages.desc': 'სიტყვები ხელმისაწვდომია ინგლისურად, ქართულად, თურქულად და რუსულად. მასპინძელი ირჩევს სიტყვების ენას ლობის პარამეტრებში.',
