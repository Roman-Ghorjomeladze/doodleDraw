    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-surface-800 rounded-t-2xl sm:rounded-card shadow-game-lg w-full sm:max-w-sm max-h-[100dvh] sm:max-h-[85vh] relative overflow-hidden flex flex-col"
